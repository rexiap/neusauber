...
.. |REPLACE9| raw:: html
    ...
    <table cellspacing="0" cellpadding="0" style="width:100%">
    <tbody>
    <tr><td style="width:49%;vertical-align:Top;padding-top:5px;padding-bottom:5px;padding-left:5px;padding-right:5px;border:solid 1px #000000"><p style="color:#38761d"><span  style="color:#38761d">售價</span></p><ul style="list-style:disc;list-style-image:inherit;padding:0px 40px;margin:initial"><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">一車份 50mL 899元 (未含稅)</span></li><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">運費65元</span></li><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">貨到付款另加30元</span></li></ul><p></td><td style="width:51%;vertical-align:Top;padding-top:5px;padding-bottom:5px;padding-left:5px;padding-right:5px;border:solid 1px #000000"><p><span  style="color:#38761d">購買方式</span></p><ul style="list-style:disc;list-style-image:inherit;padding:0px 40px;margin:initial"><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">請將訂購數量、收件人、地址、電話與付款方式，傳至如下e-mail</span></li></ul><p style="font-size:10px"><span  style="font-size:10px">             <a href="mailto:service@neusauber.com">service@neusauber.com</a></span></p><p style="font-size:10px"><span  style="font-size:10px">             我們將盡速回覆並寄出</span></p><ul style="list-style:disc;list-style-image:inherit;padding:0px 40px;margin:initial"><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">匯款帳號</span></li></ul><p style="font-size:10px"><span  style="font-size:10px">             渣打銀行(052)  八德分行</span></p><p style="font-size:10px"><span  style="font-size:10px">             意杰國際有限公司</span></p><p style="font-size:10px"><span  style="font-size:10px">             02953000626980</span></p><ul style="list-style:disc;list-style-image:inherit;padding:0px 40px;margin:initial"><li style="list-style:inherit;list-style-image:inherit"><span  style="font-size:10px">選擇匯款者請將匯款帳號末五碼附載郵件中</span></li></ul></td></tr>
    </tbody></table>
